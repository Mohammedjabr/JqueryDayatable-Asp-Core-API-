...
namespace JqueryDatatable.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        public IActionResult GetCustomers()
        {
           ...
           ? true
           : (m.FirstName.Contains(searchValue) || m.LastName.Contains(searchValue) || m.Email.Contains(searchValue) ||
            ...
            var jsonData = new { recordsFiltered = recordsTotal, customers, data };
